...
SQLRETURN ODBCConnection::GetInfo(SQLUSMALLINT info_type, SQLPOINTER value,
  ...
  switch (info_type) {
    ...
    case SQL_STRING_FUNCTIONS_ODBC:
    ...
    case SQL_CONVERT_CHAR_ODBC:
    case SQL_CONVERT_DATE_ODBC:
    case SQL_CONVERT_DECIMAL_ODBC:
    case SQL_CONVERT_DOUBLE:
    case SQL_CONVERT_FLOAT_ODBC:
    case SQL_CONVERT_GUID:
    case SQL_CONVERT_INTEGER_ODBC:
    case SQL_CONVERT_INTERVAL_DAY_TIME_ODBC:
    case SQL_CONVERT_INTERVAL_YEAR_MONTH_ODBC:
    case SQL_CONVERT_LONGVARBINARY_ODBC:
    case SQL_CONVERT_LONGVARCHAR_ODBC:
    case SQL_CONVERT_NUMERIC_ODBC:
    case SQL_CONVERT_REAL_ODBC:
    case SQL_CONVERT_SMALLINT_ODBC:
    case SQL_CONVERT_TIME_ODBC:
    case SQL_CONVERT_TIMESTAMP_ODBC:
    case SQL_CONVERT_TINYINT_ODBC:
    case SQL_CONVERT_VARBINARY_ODBC:
    case SQL_CONVERT_VARCHAR_ODBC:
