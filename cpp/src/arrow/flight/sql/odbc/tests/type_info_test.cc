...
void CheckSQLDescribeColODBCVer2(SQLHSTMT stmt) {
  const SQLWCHAR* column_names[] = {TO_SQWCHAR_PTR(L"TYPE_NAME"),
                                    TO_SQWCHAR_PTR(L"DATA_TYPE"),
                                    TO_SQWCHAR_PTR(L"PRECISION"),
                                    TO_SQWCHAR_PTR(L"LITERAL_PREFIX"),
                                    TO_SQWCHAR_PTR(L"LITERAL_SUFFIX"),
                                    TO_SQWCHAR_PTR(L"CREATE_PARAMS"),
                                    TO_SQWCHAR_PTR(L"NULLABLE"),
                                    TO_SQWCHAR_PTR(L"CASE_SENSITIVE"),
                                    TO_SQWCHAR_PTR(L"SEARCHABLE"),
                                    TO_SQWCHAR_PTR(L"UNSIGNED_ATTRIBUTE"),
                                    TO_SQWCHAR_PTR(L"MONEY"),
                                    TO_SQWCHAR_PTR(L"AUTO_INCREMENT"),
                                    TO_SQWCHAR_PTR(L"LOCAL_TYPE_NAME"),
                                    TO_SQWCHAR_PTR(L"MINIMUM_SCALE"),
                                    TO_SQWCHAR_PTR(L"MAXIMUM_SCALE"),
                                    TO_SQWCHAR_PTR(L"SQL_DATA_TYPE"),
                                    TO_SQWCHAR_PTR(L"SQL_DATETIME_SUB"),
                                    TO_SQWCHAR_PTR(L"NUM_PREC_RADIX"),
                                    TO_SQWCHAR_PTR(L"INTERVAL_PRECISION")};
...
void CheckSQLDescribeColODBCVer3(SQLHSTMT stmt) {
  const SQLWCHAR* column_names[] = {
      TO_SQWCHAR_PTR(L"TYPE_NAME"),         TO_SQWCHAR_PTR(L"DATA_TYPE"),
      TO_SQWCHAR_PTR(L"COLUMN_SIZE"),       TO_SQWCHAR_PTR(L"LITERAL_PREFIX"),
      TO_SQWCHAR_PTR(L"LITERAL_SUFFIX"),    TO_SQWCHAR_PTR(L"CREATE_PARAMS"),
      TO_SQWCHAR_PTR(L"NULLABLE"),          TO_SQWCHAR_PTR(L"CASE_SENSITIVE"),
      TO_SQWCHAR_PTR(L"SEARCHABLE"),        TO_SQWCHAR_PTR(L"UNSIGNED_ATTRIBUTE"),
      TO_SQWCHAR_PTR(L"FIXED_PREC_SCALE"),  TO_SQWCHAR_PTR(L"AUTO_UNIQUE_VALUE"),
      TO_SQWCHAR_PTR(L"LOCAL_TYPE_NAME"),   TO_SQWCHAR_PTR(L"MINIMUM_SCALE"),
      TO_SQWCHAR_PTR(L"MAXIMUM_SCALE"),     TO_SQWCHAR_PTR(L"SQL_DATA_TYPE"),
      TO_SQWCHAR_PTR(L"SQL_DATETIME_SUB"),  TO_SQWCHAR_PTR(L"NUM_PREC_RADIX"),
      TO_SQWCHAR_PTR(L"INTERVAL_PRECISION")};
  SQLSMALLINT column_data_types[] = {
      SQL_WVARCHAR, SQL_SMALLINT, SQL_INTEGER,  SQL_WVARCHAR, SQL_WVARCHAR,
      SQL_WVARCHAR, SQL_SMALLINT, SQL_SMALLINT, SQL_SMALLINT, SQL_SMALLINT,
