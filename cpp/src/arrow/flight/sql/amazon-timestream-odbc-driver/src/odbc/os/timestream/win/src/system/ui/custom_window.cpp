...
std::unique_ptr<Window> CustomWindow::CreateGroupBox(int posX, int posY, int sizeX,
...
std::unique_ptr<Window> CustomWindow::CreateEdit(int posX, int posY, int sizeX, int sizeY,
...
std::unique_ptr<Window> CustomWindow::CreateButton(int posX, int posY, int sizeX,
                                                   int sizeY, const std::wstring& title,
                                                   int id) {
  std::unique_ptr<Window> child(new Window(this, WC_BUTTON, title));
...
std::unique_ptr<Window> CustomWindow::CreateCheckBox(int posX, int posY, int sizeX,
                                                     int sizeY, const std::wstring& title,
                                                     int id, bool state) {
  std::unique_ptr<Window> child(new Window(this, WC_BUTTON, title));
...
std::unique_ptr<Window> CustomWindow::CreateComboBox(int posX, int posY, int sizeX,
                                                     int sizeY, const std::wstring& title,
                                                     int id) {
...
std::unique_ptr<Window> CustomWindow::CreateTab(int posX, int posY, int sizeX, int sizeY,
                                                const std::wstring& title, int id,
                                                int style) {
  std::unique_ptr<Window> child(new Window(this, WC_TABCONTROL, title));

  child->Create(WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_TABSTOP | style, posX, posY,
                sizeX, sizeY, id);

  return child;
}

std::unique_ptr<EDITBALLOONTIP> CustomWindow::CreateBalloon(const wchar_t* title,
                                                            const wchar_t* text,
                                                            int icon) {
