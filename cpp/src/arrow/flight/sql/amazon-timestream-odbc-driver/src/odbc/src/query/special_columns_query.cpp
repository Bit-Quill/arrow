...
SpecialColumnsQuery::SpecialColumnsQuery(diagnostic::DiagnosableAdapter& diag)
  ...
  columnsMeta.push_back(
      ColumnMeta(sch, tbl, "SCOPE", ScalarType::INTEGER, Nullability::NULLABLE));
  columnsMeta.push_back(
  ...
  columnsMeta.push_back(
      ColumnMeta(sch, tbl, "PSEUDO_COLUMN", ScalarType::INTEGER, Nullability::NULLABLE));
}
...
SqlResult::Type SpecialColumnsQuery::Cancel() { return SqlResult::AI_SUCCESS; }

const meta::ColumnMetaVector* SpecialColumnsQuery::GetMeta() { return &columnsMeta; }
...
SqlResult::Type SpecialColumnsQuery::Close() { return SqlResult::AI_SUCCESS; }

bool SpecialColumnsQuery::DataAvailable() const { return false; }

int64_t SpecialColumnsQuery::AffectedRows() const { return 0; }

SqlResult::Type SpecialColumnsQuery::NextResultSet() { return SqlResult::AI_NO_DATA; }
}  // namespace query
}  // namespace odbc
}  // namespace timestream
