...
#ifndef _TIMESTREAM_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD_STORAGE
#define _TIMESTREAM_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD_STORAGE
...
#endif  //_TIMESTREAM_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD_STORAGE
