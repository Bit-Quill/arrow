...
namespace odbc {
namespace query {
ProcedureColumnsQuery::ProcedureColumnsQuery(diagnostic::DiagnosableAdapter& diag)
  ...
  columnsMeta.push_back(
      ColumnMeta(sch, tbl, "COLUMN_TYPE", ScalarType::INTEGER, Nullability::NO_NULL));
  columnsMeta.push_back(
...
SqlResult::Type ProcedureColumnsQuery::Cancel() { return SqlResult::AI_SUCCESS; }

const meta::ColumnMetaVector* ProcedureColumnsQuery::GetMeta() { return &columnsMeta; }
...
SqlResult::Type ProcedureColumnsQuery::GetColumn(uint16_t columnIdx,
...
SqlResult::Type ProcedureColumnsQuery::Close() { return SqlResult::AI_SUCCESS; }

bool ProcedureColumnsQuery::DataAvailable() const { return false; }

int64_t ProcedureColumnsQuery::AffectedRows() const { return 0; }

SqlResult::Type ProcedureColumnsQuery::NextResultSet() { return SqlResult::AI_NO_DATA; }
}  // namespace query
}  // namespace odbc
}  // namespace timestream
