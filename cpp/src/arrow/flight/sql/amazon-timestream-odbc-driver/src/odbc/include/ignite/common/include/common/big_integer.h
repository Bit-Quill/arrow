...
#ifndef _IGNITE_ODBC_COMMON_BIG_INTEGER
#define _IGNITE_ODBC_COMMON_BIG_INTEGER

#include <ignite/common/include/common/dynamic_size_array.h>
#include <stdint.h>
...
#endif  //_IGNITE_ODBC_COMMON_BIG_INTEGER
